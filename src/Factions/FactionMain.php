...
class FactionMain extends PluginBase implements Listener {
	...
	public function onEnable() {
		...
		$this->prefs = new Config($this->getDataFolder() . "Settings.yml", CONFIG::YAML, array(
 ...
 /*   public function getAllAllies($faction){
	...
	public function formatMessage($string, $confirm = false) {
		if($confirm) {
			return "[" . TextFormat::GOLD . "§bFactions" . TextFormat::WHITE . "] " . TextFormat::GREEN . "$string";
		} else {	
			return "[" . TextFormat::GOLD . "§bFactions" . TextFormat::WHITE . "] " . TextFormat::RED . "$string";
		}
	}
